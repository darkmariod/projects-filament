...
return [
    ...
    */
    ...
    'password'             => [
        ...
        'uncompromised' => 'El :attribute proporcionado aparece en una filtración de datos. Elegí un :attribute diferente.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        // Composición técnica
        'cover_material'        => 'material de cubierta',
        'foam_description'      => 'descripción de espuma',
        'springs'               => 'resortes',
        'conservation_instructions' => 'instrucciones de conservación',
        'manufacturer'          => 'fabricante',
        'manufacturer_ruc'      => 'RUC del fabricante',
        'manufacturer_address'  => 'dirección del fabricante',
        'inen_standard'         => 'norma INEN',
        'website'               => 'sitio web',
        ...
        'qr_url'                => 'URL del QR',
        'zpl_generated'         => 'ZPL generado',
        'printed_at'            => 'impreso el',
        'registered_at'         => 'registrado el',
        'label_batch_id'        => 'lote de etiquetas',

        // Lotes de etiquetas
        'internal_batch_code'   => 'código interno del lote',
        'customer_batch_number' => 'número de lote del cliente',
        'customer_batch_date'   => 'fecha del lote del cliente',
        'quantity'              => 'cantidad',
        'operator'              => 'operador',
        'observations'          => 'observaciones',
        'generated_by_user_id'  => 'generado por',
        ...
        'printer_model'         => 'modelo de la impresora',
        'printer_ip'            => 'IP de la impresora',
        'printer_port'          => 'puerto de la impresora',
        'connection_type'       => 'tipo de conexión',
        'dpi'                   => 'DPI',
        'label_width_mm'        => 'ancho de etiqueta (mm)',
        'label_height_mm'       => 'alto de etiqueta (mm)',
        'label_gap_mm'          => 'separación entre etiquetas (mm)',
        'width_dots'            => 'ancho en dots',
        'height_dots'           => 'alto en dots',
        'margin_x'              => 'margen X',
        'margin_y'              => 'margen Y',
        'qr_size'               => 'tamaño del QR',
        'barcode_height'        => 'alto del código de barras',
        ...
        'product.product_code'  => 'código del producto',
        'product.measurements_text' => 'medidas',
        'productModel.name'     => 'nombre del modelo',
        'productModel.warranty_years' => 'años de garantía',
        'productModel.category_id' => 'categoría',
        'labelBatch.customer_batch_number' => 'número de lote',
        'labelBatch.customer_batch_date' => 'fecha de lote',
    ],
];
