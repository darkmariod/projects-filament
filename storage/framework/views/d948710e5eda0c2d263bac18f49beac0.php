...
<head>
    <meta charset="UTF-8">
    <title>Certificado de Garantía - <?php echo e($label->serial); ?></title>
    <style>
...
<div class="page">
    ...
    <div class="serial-box">
        ...
        <div class="code"><?php echo e($label->serial); ?></div>
    </div>

    <div class="validity-box">
        <div class="title">Garantía vigente hasta</div>
        <div class="date"><?php echo e($label->warranty->warranty_end_date->format('d/m/Y')); ?></div>
    </div>
        ...
        <div class="col">
            ...
            <div class="section">
                ...
                <div class="row">
                    ...
                    <div class="value"><?php echo e($label->warranty->customer->full_name); ?></div>
                </div>
                <div class="row">
                    <div class="label">Documento</div>
                    <div class="value"><?php echo e(strtoupper($label->warranty->customer->document_type)); ?>: <?php echo e($label->warranty->customer->document_number); ?></div>
                </div>
                <div class="row">
                    <div class="label">Correo electrónico</div>
                    <div class="value"><?php echo e($label->warranty->customer->email); ?></div>
                </div>
                <div class="row">
                    <div class="label">Celular</div>
                    <div class="value"><?php echo e($label->warranty->customer->phone); ?></div>
                </div>
                <div class="row">
                    <div class="label">Dirección</div>
                    <div class="value"><?php echo e($label->warranty->customer->address); ?>, <?php echo e($label->warranty->customer->city); ?> - <?php echo e($label->warranty->customer->province); ?></div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="row">
                    ...
                    <div class="value"><?php echo e($label->warranty->store_name); ?></div>
                </div>
                <div class="row">
                    <div class="label">Número de factura</div>
                    <div class="value"><?php echo e($label->warranty->invoice_number); ?></div>
                </div>
                <div class="row">
                    <div class="label">Fecha de compra</div>
                    <div class="value"><?php echo e($label->warranty->purchase_date->format('d/m/Y')); ?></div>
                </div>
                <div class="row">
                    <div class="label">Inicio de garantía</div>
                    <div class="value"><?php echo e($label->warranty->warranty_start_date->format('d/m/Y')); ?></div>
                </div>
            </div>
        ...
        <div class="col">
            ...
            <div class="section">
                ...
                <div class="row">
                    ...
                    <div class="value"><?php echo e($label->product->name); ?></div>
                </div>
                <div class="row">
                    <div class="label">Modelo</div>
                    <div class="value"><?php echo e($label->product->productModel->name); ?></div>
                </div>
                <div class="row">
                    <div class="label">Medidas</div>
                    <div class="value"><?php echo e($label->product->measurements_text); ?></div>
                </div>
                <div class="row">
                    <div class="label">Tipo</div>
                    <div class="value"><?php echo e($label->product->productModel->type); ?></div>
                </div>
                <div class="row">
                    <div class="label">Período de garantía</div>
                    <div class="value"><?php echo e($label->product->productModel->warranty_years); ?> años</div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="row">
                    ...
                    <div class="value"><?php echo e($label->labelBatch->customer_batch_number); ?></div>
                </div>
                <div class="row">
                    <div class="label">Fecha de fabricación</div>
                    <div class="value"><?php echo e($label->labelBatch->customer_batch_date->format('d/m/Y')); ?></div>
                </div>
            </div>
    ...
    <div class="legal">
        ...
        <p>
            Esta garantía cubre defectos de fabricación por un período de <?php echo e($label->product->productModel->warranty_years); ?> años a partir de la fecha de compra. 
    ...
    <div class="footer">
        ...
        <div class="generated">Documento generado digitalmente el <?php echo e(now()->format('d/m/Y \a \l\a\s H:i')); ?></div>
    </div>

</div>
</body>
</html>
<?php /**PATH /Users/mariopazmino/Documents/Codex/sistema-garantias/resources/views/public/certificate-pdf.blade.php ENDPATH**/ ?>