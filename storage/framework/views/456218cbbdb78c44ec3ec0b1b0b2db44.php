...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="success-subtitle"><?php echo e($label->warranty->customer->first_name); ?> <?php echo e($label->warranty->customer->last_name); ?>, tu garantía ha sido registrada con éxito.</div>
        ...
        <div class="section">
            ...
            <div class="row">
                ...
                <span class="value-text"><?php echo e($label->warranty->customer->full_name); ?></span>
            </div>
            <div class="row">
                <span class="label-text">Documento</span>
                <span class="value-text"><?php echo e(strtoupper($label->warranty->customer->document_type)); ?>: <?php echo e($label->warranty->customer->document_number); ?></span>
            </div>
            <div class="row">
                <span class="label-text">Email</span>
                <span class="value-text"><?php echo e($label->warranty->customer->email); ?></span>
            </div>
            <div class="row">
                <span class="label-text">Celular</span>
                <span class="value-text"><?php echo e($label->warranty->customer->phone); ?></span>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="row">
                ...
                <span class="value-text"><?php echo e($label->warranty->store_name); ?></span>
            </div>
            <div class="row">
                <span class="label-text">Factura</span>
                <span class="value-text"><?php echo e($label->warranty->invoice_number); ?></span>
            </div>
            <div class="row">
                <span class="label-text">Fecha de compra</span>
                <span class="value-text"><?php echo e($label->warranty->purchase_date->format('d/m/Y')); ?></span>
            </div>
        </div>

        <div class="actions">
            <a href="<?php echo e(route('public.warranty.certificate', $label->serial) . '?download=1'); ?>" class="btn btn-success">
                Descargar certificado PDF
            </a>
            <a href="<?php echo e(route('public.product', $label->serial)); ?>" class="btn btn-outline">
                Ver producto
            </a>
        </div>
...
<?php /**PATH /Users/mariopazmino/Documents/Codex/sistema-garantias/resources/views/public/warranty-confirm.blade.php ENDPATH**/ ?>