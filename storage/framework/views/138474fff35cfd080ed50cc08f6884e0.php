    ...
    <div class="w">
        <div class="nv">
            ...
            <div class="nv-r">
                ...
                <a href="/admin" class="b b2" style="padding:6px 14px; font-size:.75rem;">Iniciar sesión</a>
            </div>
        </div>
    </div>
    ...
    <div class="ft">
        <div class="w fg">
            ...
            <div>
                <h4>Legales</h4>
                <ul>
                    <li><a href="<?php echo e(route('public.terms')); ?>">Términos y condiciones</a></li>
                    <li><a href="<?php echo e(route('public.privacy')); ?>">Protección de datos</a></li>
                    <li><a href="<?php echo e(route('public.cookies')); ?>">Política de cookies</a></li>
                </ul>
            </div>
        </div>
        <div class="w">
            <div class="cp">&copy; <?php echo e(date('Y')); ?> Productos Paraíso del Ecuador · Sistema de Garantías · www.paraiso.com.ec<br>Desarrollado por <a href="https://monkeycomputer-landing.vercel.app/" target="_blank" rel="noopener noreferrer">MonkeyComputer</a></div>
        </div>
    </div>

<div id="cb">
    <p>Este sistema usa cookies técnicas para funcionar. Al continuar acepta nuestra <a href="<?php echo e(route('public.cookies')); ?>">Política de cookies</a> y <a href="<?php echo e(route('public.privacy')); ?>">Protección de datos</a>.</p>
...
<?php /**PATH /Users/mariopazmino/Documents/Codex/sistema-garantias/resources/views/welcome.blade.php ENDPATH**/ ?>