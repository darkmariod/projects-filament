...
<div id="cb">
    <p>Este sistema usa cookies técnicas para funcionar. Al continuar acepta nuestra <a href="{{ route('public.cookies') }}">Política de cookies</a> y <a href="{{ route('public.privacy') }}">Protección de datos</a>.</p>
